...
<html lang="en">
  ...
  <head>
    ...
    <title>Rapor- MAGS ACCESSORİES</title>
            ...
            <div class="row">
                <div class="col-lg-28">
                    <div class="left-image">
                        <img src="assets/images/rapor3.png" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="right-content">
                        <h4>PROJEDE KULLANDIĞIM TEKNOLOJİLER</h4>
                        <span>Projem genel hatlarıyla güçlü bir html-css yapısına sahiptir. Projedeki amaç basit bir e-ticaret sitesi oluşturmak, bu sebeple ürünlerin sergilendiği ve sepet kısmıyla birlikte ürünü satın alma ekranına yönlendiren bir sayfa ekledim. İleride projeye admin panel ekleneceği için sepete kaç ürün eklendi gibi kısımları yapmadım. Mysql ile verileri çekerek ürünün resmini, ismini, açıklamasını ve fiyat gibi bilgilerini  ekranlar arasında eşleşmesini sağladım, ve gereksiz şemadan kaçındım.</span>
                        <div class="quote">
                          <li>-PHP</li>
                             <li>-Free css Orjinal Template</li>
                                <li>-MySql</li>
                                   <li>-Jquery</li>
                                      <li>-JavaScrpit</li>
                                       <li>-HTML5</li>
                                           <li><a href="https://www.free-css.com/free-css-templates/page293/hexashop">Kullandığım template</a></li>
